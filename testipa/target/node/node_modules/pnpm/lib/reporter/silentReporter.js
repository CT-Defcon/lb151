...
exports.default = (streamParser) => {
    streamParser.on('data', (obj) => {
        ...
        if ((_a = obj['err'].code) === null || _a === void 0 ? void 0 : _a.startsWith('ERR_PNPM_'))
            return;
        console.log((_c = (_b = obj['err']) === null || _b === void 0 ? void 0 : _b.message) !== null && _c !== void 0 ? _c : obj['message']); // eslint-disable-line
        if ((_d = obj['err']) === null || _d === void 0 ? void 0 : _d.stack) { // eslint-disable-line
