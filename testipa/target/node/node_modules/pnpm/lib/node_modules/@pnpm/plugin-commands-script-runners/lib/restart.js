...
async function handler(opts, params) {
    await run_1.handler(opts, ['stop', ...params]);
    await run_1.handler(opts, ['restart', ...params]);
    await run_1.handler(opts, ['start', ...params]);
}
