...
const outdated_1 = __importDefault(require("./outdated"));
...
async function outdatedDepsOfProjects(pkgs, args, opts) {
    ...
    const wantedLockfile = (_c = await lockfile_file_1.readWantedLockfile(lockfileDir, { ignoreIncompatible: false })) !== null && _c !== void 0 ? _c : currentLockfile;
    ...
    return Promise.all(pkgs.map(({ dir, manifest }) => {
        const match = args.length && matcher_1.default(args) || undefined;
