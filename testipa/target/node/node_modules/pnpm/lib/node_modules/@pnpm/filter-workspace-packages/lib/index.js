...
exports.filterPkgsBySelectorObjects = exports.filterPackages = exports.readProjects = exports.parsePackageSelector = void 0;
...
const pkgs_graph_1 = __importDefault(require("pkgs-graph"));
const getChangedPackages_1 = __importDefault(require("./getChangedPackages"));
const parsePackageSelector_1 = __importDefault(require("./parsePackageSelector"));
...
async function readProjects(workspaceDir, pkgSelectors, opts) {
    ...
    const { selectedProjectsGraph } = await filterPkgsBySelectorObjects(allProjects, pkgSelectors, {
        linkWorkspacePackages: opts === null || opts === void 0 ? void 0 : opts.linkWorkspacePackages,
        workspaceDir,
    });
...
function filterPkgsBySelectorObjects(pkgs, packageSelectors, opts) {
    const { graph } = pkgs_graph_1.default(pkgs, { linkWorkspacePackages: opts.linkWorkspacePackages });
    if (packageSelectors === null || packageSelectors === void 0 ? void 0 : packageSelectors.length) {
