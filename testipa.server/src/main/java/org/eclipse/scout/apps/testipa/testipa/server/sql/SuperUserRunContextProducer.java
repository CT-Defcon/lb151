...
import org.eclipse.scout.apps.testipa.testipa.server.sql.DatabaseProperties.SuperUserSubjectProperty;
...
public class SuperUserRunContextProducer extends ServerRunContextProducer {
	 ...
	 *
	 * @param subject
	 *            is ignored, and {@link SuperUserRunContextProducer#getSubject()}
	 *            used instead.
	 * @see #produce()
	 */
	@Override
	 ...
	 * Produces a new {@link ServerRunContext} with super user rights.
	 * <p>
	 * This implies a new {@link ServerRunContext} initialized with the superuser's
	 * {@link Subject}, with a dedicated {@link RunMonitor} set, and the superuser's
	 * shared {@link IServerSession} set.
	 */
	...
	/**
	 * Method invoked to create the superuser's {@link IServerSession} with data as
	 * specified by the given {@link ServerRunContext}.
	 */
	 ...
	 * stopping) isn't going to work because the BEANS.get (and others) cannot be
	 * used anymore when that platform is stopped.
	 */
